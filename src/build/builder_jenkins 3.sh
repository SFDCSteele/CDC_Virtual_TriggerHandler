...
echo "#####builder_jenkins.sh: branch is $GITBRANCH---version 000.113...($ANT_HOME)...(GIT COMMITTER: $CI_COMMITTER_NAME)..."
echo "==========================================================================="
whoami
#ls -al
#pwd
...
for env in "${envs[@]}"; do
    ...
    then
        ...
        export execute_deploy=TRUE
        #
    elif [[ ( "$env" = "UATVAPM" ) || ( "$env" = "VAPM" ) || ( "$env" = "STAGEVAPM" ) || ( "$env" = "CTALBOTVA" ) ]]
    then
    ...
    then
        echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
        echo "The branch contains work files that will prevent this branch from automerging, deleting and re-pushing"
        echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
        export execute_deploy=FALSE
    ...
    then
        ...
        then
            ...
            if [ -f "$repoLocation/src/build/Releases/$releaseBranch2/Package_*-ENH-*.xml" ]
            then
